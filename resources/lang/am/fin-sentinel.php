...
return [
    ...
    'navigation' => [
        ...
        'debug_channel' => 'የ Debug ቻናል',
        'debug_channel_title' => 'የ Debug ቻናል ቅንብሮች',
    ...
    'email' => [
        ...
        'label' => [
            ...
            'user' => 'ተጠቃሚ',
            'environment' => 'አካባቢ',
            'debug_mode' => 'የ Debug ሁነታ',
            'php_version' => 'የ PHP ስሪት',
            'laravel_version' => 'የ Laravel ስሪት',
            'laravel' => 'Laravel',
    ...
    'settings' => [
        ...
        'debug' => [
            'enabled' => 'የ Debug ቻናልን አንቃ',
            'enabled_helper' => 'ሲሰናከል፣ Sentinel::debug() ጥሪዎች በጸጥታ ይዘለላሉ።',
            'recipients_helper' => 'የ Debug ማሳወቂያዎችን የሚቀበሉ የኢሜይል አድራሻዎችን ያክሉ።',
            'throttle_enabled' => 'ገደብ መጣልን አንቃ',
            'throttle_enabled_helper' => 'ሲሰናከል፣ እያንዳንዱ የ Debug ጥሪ ኢሜይል ይልካል። ሲነቃ፣ ተደጋጋሚ ጥሪዎች ይገደባሉ።',
            'throttle_helper' => 'በተደጋጋሚ የ Debug ኢሜይሎች መካከል ዝቅተኛ ደቂቃዎች።',
        ],

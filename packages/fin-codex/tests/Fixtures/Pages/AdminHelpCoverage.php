...
/**
 * What a host's own coverage page looks like: a subclass, nothing more. The
 * admin panel names it through coveragePage(), so FinCodexPlugin::register()
 ...
 */
final class AdminHelpCoverage extends HelpCoverage {}

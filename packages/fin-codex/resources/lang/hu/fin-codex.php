    ...
    'editor' => [
        ...
        'contexts' => [
            ...
            'auth' => [
                ...
                'password_reset_request' => 'Jelszó-visszaállítás kérése',
                'password_reset' => 'Jelszó visszaállítása',
                'email_verification' => 'E-mail megerősítése',
                'profile' => 'Profiloldal',
                'mfa_setup' => 'Kétfaktoros beállítás',
            ],
            'auth_any_panel' => 'A bejelentkezési és fiókoldalak a Bármely panel alatt szerepelnek — az alkalmazáshoz tartoznak, nem egyetlen panelhez.',
            'key_cleared' => 'A választás törölve',
            'key_cleared_body' => 'Ez a választás nem érhető el a most kiválasztott panelen.',
            'key_panel_warning' => 'Ezt a kulcsot csak a(z) :panel panel regisztrálja, így a Bármely panel nem ad hozzá semmit.',
            'url_panel_warning' => 'Ez a minta a(z) :panel panel alá tartozik, nem az itt kiválasztott alá.',
        ],
        'picker' => [
            'title' => 'Cím',
            'slug' => 'Slug (útvonal)',
